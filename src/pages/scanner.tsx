  ...
  return (
    <Box sx={{ pb: 8 }}>
      ...
      <Box sx={{ px: 3, pt: 3, pb: 2 }}>
        <Typography variant="h5" fontWeight={800} letterSpacing={-0.5}>Resume Scanner</Typography>
        ...
        <Stack spacing={1.5}>
          ...
          <Paper sx={{ p: 2 }}>
            ...
            {jdList.length === 0 ? (
              ...
              >
                No job descriptions yet — click <strong>Add JD</strong> to create one.
              </Alert>
            ) : (
              <Stack spacing={2}>
            ...
            <Paper sx={{ p: 2 }}>
              ...
              <Stack direction="row" alignItems="center" spacing={0.75} sx={{ mb: 1.5, color: 'text.secondary' }}>
                ...
                <Typography variant="caption">
                  ...
                  <strong>info icon</strong> on any row to see the per-criterion breakdown.
                </Typography>
              </Stack>
